...
const photoSelections: Photo[] = [
  ...
  { src: 'RexMaternity118.jpg', caption: 'Holding hands knowing we got this' },
  ...
  { src: 'RexMaternity49.jpg', caption: 'Serenity for a brief moment before Amanda runs to warm up from the cold' },
